  ...
  return (
    <>
      <div className="pec">
        <div className="pec__info">
          {tag && (
            <div className="pec__info__tag">
              <img alt="" className="pec__info__tag__img" src={tagLogo} />
          ...
          {eventType && (
            <div className="pec__info__type">
              <img
                alt=""
                className="pec__info__tag__img"
                src={`/icons/pln-event-${eventType.toLowerCase().trim()}.svg`}
              />
        ...
        {website && (
          <p className="pec__eventname">
            <a className="blue" href={website} target="_blank">
        ...
        <div className="pec__location">
          <img alt="" className="pec__location__img" src={locationLogo} />
          {!venueMapsLink && (
            <p className="pec__location__text">{fullAddressValue}</p>
          )}
          {venueMapsLink && (
            <a
              className="pec__location__link"
              href={venueMapsLink}
              target="_blank"
            >
              <p className="pec__location__text location-blue">
                {fullAddressValue}
              </p>
            </a>
          )}
