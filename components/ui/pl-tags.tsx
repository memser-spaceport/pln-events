        ...
        <style jsx>
            {
                ...
                .plt__item {font-size: 12px; color: #0F172A; cursor: pointer; margin-right:6px; margin-bottom: 4px; padding: 6px 12px; border: 1px solid lightgrey; border-radius: 20px;}
